...
class _JobCardCompanyState extends State<JobCardCompany> {
  String timeAgo(DateTime postDate) {
    ...
    final now = DateTime.parse(DateFormat('yyyy-MM-dd HH:mm:ss').format(DateTime.now()));
    String formattedDate = DateFormat('yyyy-MM-dd HH:mm:ss').format(postDate);
    // print(formattedDate);
    final difference = now.difference(DateTime.parse(formattedDate));
    // print(difference);
  ...
  Widget build(BuildContext context) {
    ...
    String postedTimeAgo = timeAgo(DateTime.parse(widget.cjob.postDate ?? DateTime.now().toIso8601String()));
