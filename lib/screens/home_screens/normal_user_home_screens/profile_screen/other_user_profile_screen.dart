              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (widget.user.button!.display == true)
                      CustomProfileButton(
                        data: widget.user.button?.linkText ??
                            "Button",
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AnalyticsToolContainer(
                      ...
                      heading:
                      (widget.user.profileViews.toString() ??
                          "0") +
                          ' Profile Views',
                    ...
                    AnalyticsToolContainer(
                      ...
                      heading:
                      (widget.user.searchCount.toString() ??
                          "0") +
                          ' search appearances',
                      subheading:
                      ...
                      children: [
                        Text(
                          showMore
                              ...
                              : HelperFunctions.truncateDescription(widget.user.about ?? "About", 150),
                          style: TextStyle(
                            fontSize: 16,
                          ),
                        ),
                        if ((widget.user.about?.length ?? 0) > 150) // Only show the button if there's more text
                          TextButton(
                            onPressed: () {
                              setState(() {
                                showMore = !showMore;
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return ExperienceCard(
                                    experience: widget.user.experiences![index]);
                              },
                            ),
                          if ((widget.user.experiences?.length ??
                              0) >
                              2)
                            InkWell(
                              onTap: () {
                                Navigator.push(context,
                                    LeftToRight(ShowMoreExperienceScreen(user: widget.user,)));
                              },
                              child: Container(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if ((widget.user.educations?.length ??
                              0) >
                              2)
                            InkWell(
                              onTap: () {
                                Navigator.push(context,
                                    LeftToRight(ShowMoreEducation(user: widget.user,)));
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5),
                        ...
                        children: [
                          ...
                          if ((widget.user.projects?.length ?? 0) >
                            ...
                            InkWell(
                              onTap: () {
                                Navigator.push(
                                    context, LeftToRight(ShowMoreProject(user: widget.user,)));
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5),
                        ...
                        children: [
                          ...
                          if (widget.user.skills?.length != 0)
                            ListView.builder(
                              ...
                              (widget.user.skills?.length ??
                                  ...
                                  : widget.user.skills?.length,
                              itemBuilder: (context, index) {
                                return SkillCard(skill: widget.user.skills?[index] ?? Skill());
                              },
                            ),
                          if ((widget.user.skills?.length ?? 0) > 2)
                            InkWell(
                              onTap: () {
                                Navigator.push(
                                    context, LeftToRight(ShowMoreSkills(user: widget.user,)));
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if ((widget.user.testScores?.length ??
                              0) >
                              3)
                            InkWell(
                              onTap: () {
                                Navigator.push(context,
                                    LeftToRight(ShowMoreTestscore(user: widget.user,)));
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5),
                        ...
                        children: [
                          ...
                          if ((widget.user.languages?.length ?? 0) >
                            ...
                            InkWell(
                              onTap: () {
                                Navigator.push(context,
                                    LeftToRight(ShowMoreLanguageScreen(user: widget.user,)));
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5),
