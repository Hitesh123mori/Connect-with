...
class AllFollowersAndFollowingsUser extends StatefulWidget {
  final bool isFollowers ;
  final List<String> ids;
  const AllFollowersAndFollowingsUser({super.key, required this.isFollowers, required this.ids});

  @override
  State<AllFollowersAndFollowingsUser> createState() => _AllFollowersAndFollowingsUserState();
}

class _AllFollowersAndFollowingsUserState extends State<AllFollowersAndFollowingsUser> {
        ...
        body: isLoading
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              Text(
                widget.isFollowers ?  "No Followers!" : "No Following",
