...
class OtherCompanyJobsShowMore extends StatefulWidget {
  final List<CompanyJob> cjobs ;
  final Organization org;
  const OtherCompanyJobsShowMore({Key? key, required this.cjobs, required this.org}) : super(key: key);

  @override
  State<OtherCompanyJobsShowMore> createState() =>
      _JobShowMoreScreenCompanyState();
}

class _JobShowMoreScreenCompanyState extends State<OtherCompanyJobsShowMore> {
                  ...
                  children: [
                    ...
                    if (!isLoading && _filteredJobs.isNotEmpty)
                      ListView.builder(
                        ...
                        physics: const NeverScrollableScrollPhysics(),
                        itemBuilder: (context, index) {
                          return JobCardCompany(cjob: _filteredJobs[index], org: widget.org,);
                        },
                      )
                    else
                      Container(
